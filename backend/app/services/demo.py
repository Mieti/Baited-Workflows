...
from app.schemas.workflow import WorkflowDefinition, WorkflowLayout


DEMO_WORKFLOW_ID = UUID("b9f8f3c5-2bd1-4f1e-94d5-b31f4ed8f4da")
DEMO_WORKFLOW_NAME = "Baited demo workflow"
DEMO_WORKFLOW_DESCRIPTION = "Email phishing follow-up with risk branching and training assignment."


DEMO_DEFINITION = WorkflowDefinition.model_validate(
    {
        "schemaVersion": 1,
        "nodes": [
            {
...
DEMO_LAYOUT = WorkflowLayout.model_validate(
    {
        "nodes": {
            "start": {"x": -220, "y": 20},
            "email": {"x": 40, "y": 20},
